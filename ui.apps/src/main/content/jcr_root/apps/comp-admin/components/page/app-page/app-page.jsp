...
<html class="coral-App">
    <head>
        ...
        <title>${pageTitle} | Component Admin Console</title>
    ...
    <body class="acs-commons-page coral--light">
        <div id="acs-commons-${component.name}-app">
            ...
            <div class="page" role="main">
                <div class="content">
                    <div class="content-container" style="padding-top:2rem;top:0;";>
                        <div class="content-container-inner" style="width:960px;margin:0 auto;">
